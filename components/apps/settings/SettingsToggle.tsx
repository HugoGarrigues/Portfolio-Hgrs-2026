    ...
    return (
        <div className="flex items-center justify-between p-4 bg-black/[0.03] dark:bg-white/[0.02] border border-border-subtle rounded-xl hover:bg-black/5 dark:bg-white/[0.03] transition-colors min-h-[44px]">
            <div className="flex flex-col">
                ...
                {description && (
                    <span className="text-[12px] text-foreground/40 mt-0.5">
                        {description}
                    </span>
                )}
            </div>
            ...
            <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#161616] ${checked ? '' : 'bg-black/20 dark:bg-white/20'
                    }`}
            >
                <span
